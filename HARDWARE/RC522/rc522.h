...
#define SET_SPI_CS  (GPIOA->BSRR=0X08)	//把GPIOA port 0升为高电平(PA3=1)(GPIOA->BSRR=0X08)	
#define CLR_SPI_CS  (GPIOA->BRR=0X08)	  //把GPIOA port 0降为低电平(PA3=0)
#define SET_RC522RST  GPIOB->BSRR=0X1000	//把GPIOA port 1升为高电平(PA4=1)
#define CLR_RC522RST  GPIOB->BRR=0X1000	  //把GPIOA port 1降为低电平(PA4=0)
